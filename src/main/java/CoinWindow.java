...
import com.dishan.aof.handler.CoinRefreshHandler;
import com.dishan.aof.handler.YahooCoinHandler;
    ...
    static {
        ...
        table.getTableHeader().addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                instance.setValue(TableConstants.COIN_TABLE_HEADER_KEY, tableHeadChange
