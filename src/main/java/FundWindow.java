...
import com.dishan.aof.handler.TianTianFundHandler;
import org.apache.commons.collections.CollectionUtils;
import org.apache.commons.lang.StringUtils;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;
import com.dishan.aof.quartz.HandlerJob;
import com.dishan.aof.quartz.QuartzManager;
import com.dishan.aof.utils.*;
...
public class FundWindow implements ToolWindowFactory {
    ...
    private GridStrategyWindow gridStrategyWindow = new GridStrategyWindow();
    private OperateTraceWindow operateTraceWindow  = new OperateTraceWindow();
    ...
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        ...
        // 网格策略window
        Content content_gridStrategy = contentFactory.createContent(gridStrategyWindow.getmPanel(), GridStrategyWindow.NAME, false);
        // 操作记录
        Content operateTrace = contentFactory.createContent(operateTraceWindow.getmPanel(), OperateTraceWindow.NAME, false);
        ...
        contentManager.addContent(content_gridStrategy);
        contentManager.addContent(operateTrace);
...
//        });
    ...
    public void init(ToolWindow window) {
        ...
        if (Objects.nonNull(fundRefreshHandler)) {
            LogUtil.info("art of fishing UI已初始化");
            return;
        }
        ...
        table.getTableHeader().addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                instance.setValue(TableConstants.FUND_TABLE_HEADER_KEY, tableHeadChange
