...
import com.dishan.aof.handler.SinaStockHandler;
import com.dishan.aof.handler.StockRefreshHandler;
import com.dishan.aof.handler.TencentStockHandler;
...
import com.dishan.aof.utils.PopupsUiUtil;
    ...
    static {
        ...
        table.getTableHeader().addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                instance.setValue(TableConstants.STOCK_TABLE_HEADER_KEY, tableHeadChange
