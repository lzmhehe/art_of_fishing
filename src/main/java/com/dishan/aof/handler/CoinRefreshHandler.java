...
public abstract class CoinRefreshHandler extends DefaultTableModel {
    ...
    static {
        ...
        String tableHeader = instance.getValue(TableConstants.COIN_TABLE_HEADER_KEY);
        if (StringUtils.isBlank(tableHeader)) {
            instance.setValue(TableConstants.COIN_TABLE_HEADER_KEY, TableConstants.COIN_TABLE_HEADER_VALUE);
            tableHeader = TableConstants.COIN_TABLE_HEADER_VALUE;
        }
    ...
    private void columnColors(boolean colorful) {
        ...
        int columnIndex = TableConstants.getColumnIndexByName(columnNames, "涨跌幅");
